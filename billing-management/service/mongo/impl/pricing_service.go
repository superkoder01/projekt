...
func NewPricingService(c collections.Collection) *pricingService {
	return &pricingService{collection: c}
}

func (c *pricingService) List(ctx *gin.Context, query *utils.Query) (model.Model, error) {
...
func (c *pricingService) FindOne(id string) (model.Model, error) {
...
func (c *pricingService) Create(ctx *gin.Context, model model.Model) (string, error) {
...
func (c *pricingService) Update(ctx *gin.Context, id string, model model.Model) (model.Model, error) {
